...
let mistakeFAQTitleString = "There is a mistake!"
let mistakeFAQMessageString = "You found a mistake?\nPlease hurry and contact us!"

let mistakeFAQTitle = NSAttributedString(string: mistakeFAQTitleString, attributes: [NSAttributedString.Key.font : ArialRoundedMTBoldFont!, NSAttributedString.Key.foregroundColor : blackColor])
let mistakeFAQMessage = NSAttributedString(string: mistakeFAQMessageString, attributes: [NSAttributedString.Key.font : ArialRoundedMTLightFont!, NSAttributedString.Key.foregroundColor : blackColor])

class FAQSDetailViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    func mistakeEmail() {
        let subjectText = "Report Bug in FAQ's View (Theos Tutorials)"
    ...
    @IBAction func mistakeBarButtonTapped(_ sender: UIBarButtonItem) {
        ...
        let mistakeAlert = UIAlertController(title: mistakeFAQTitleString, message: mistakeFAQMessageString, preferredStyle: .alert)
        
        mistakeAlert.setValue(mistakeFAQTitle, forKey: "attributedTitle")
        mistakeAlert.setValue(mistakeFAQMessage, forKey: "attributedMessage")
