...
let mistakeLibraryTitleString = "There is a mistake!"
let mistakeLibraryMessageString = "You found a mistake?\nPlease hurry and contact us!"

let mistakeLibraryTitle = NSAttributedString(string: mistakeLibraryTitleString, attributes: [NSAttributedString.Key.font : ArialRoundedMTBoldFont!, NSAttributedString.Key.foregroundColor : blackColor])
let mistakeLibraryMessage = NSAttributedString(string: mistakeLibraryMessageString, attributes: [NSAttributedString.Key.font : ArialRoundedMTLightFont!, NSAttributedString.Key.foregroundColor : blackColor])

class LibraryDetailViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    func splitViewController(_ svc: UISplitViewController, shouldHideViewController vc: LibraryDetailViewController, inOrientation orientation: UIInterfaceOrientation = .portrait) -> Bool {
    ...
    func mistakeEmail() {
        let subjectText = "Report Bug in Library View (Theos Tutorials)"
    ...
    @IBAction func mistakeBarButtonTapped(_ sender: UIBarButtonItem) {
        ...
        let mistakeAlert = UIAlertController(title: mistakeLibraryTitleString, message: mistakeLibraryMessageString, preferredStyle: .alert)
        
        mistakeAlert.setValue(mistakeLibraryTitle, forKey: "attributedTitle")
        mistakeAlert.setValue(mistakeLibraryMessage, forKey: "attributedMessage")
